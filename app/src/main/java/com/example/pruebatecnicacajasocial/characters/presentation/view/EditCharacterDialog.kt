...
fun EditCharacterDialog(
    ...
    var nameCharacter by remember { mutableStateOf(name) }

    AlertDialog(
        onDismissRequest = { onDismiss() },
        title = { Text(stringResource(R.string.editar_personaje), color = Color.Black) },
        text = {
            Column {
                Text(stringResource(R.string.cambie_el_nombre_del_personaje), color = Color.Black, fontSize = 14.sp)
